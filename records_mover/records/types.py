...
RecordsFormatType.__doc__ = """Valid string values for the general format of records data file ("records
format type")."""

DelimitedVariant = Literal['dumb', 'csv', 'bigquery', 'bluelabs', 'vertica']
DelimitedVariant.__doc__ = """Valid string values for the variant of a delimited records format.
