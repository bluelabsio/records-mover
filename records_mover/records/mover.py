...
def move(records_source: RecordsSource,
    ...
    :param records_source: object returned by a factory method in :class:`records_mover.records.targets.RecordsTargets` which represents the place we're copying records to.
