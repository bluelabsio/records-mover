...
class CopyOptimizer:
    ...
    def optimize_temp_second_location(self,
        ...
        if permanent_first_loc.scheme == 's3' and temp_second_loc.scheme == 'gs':
            ...
            with self._gcp_data_transfer._optimize_temp_second_location_for_gcp_data_transfer(permanent_first_loc,
                                                                           temp_second_loc) as\
    ...
    def optimize_temp_locations(self,
        ...
        if temp_first_loc.scheme == 's3' and temp_second_loc.scheme == 'gs':
            ...
            with self._gcp_data_transfer._optimize_temp_locations_for_gcp_data_transfer(temp_first_loc,
                                                                     temp_second_loc) as\
