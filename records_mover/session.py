...
class Session():
    def __init__(self,
        ...
        :param default_db_creds_name: Name of the database credential to used when :meth:`records_mover.Session.get_default_db_engine` is called.  If not specified, the default will depend on the session type.
        :param default_aws_creds_name: Name of the AWS IAM credential to used when needed, e.g. when reading or writing to an s3:// URL.  This will be inferred unless directly specified.
        :param default_gcp_creds_name: Name of the GCP Cloud IAM credential to used when needed, e.g. when reading or writing to an gs:// URL.  This will be inferred unless directly specified.
        :param session_type: What assumptions to use when inferring and/or looking up credentials.  Valid values of "airflow" (for code running in Apache Airflow), "cli" (for running on the command-line", "lpass" (for using the LastPass password manager for credentials), and 'env' (for looking up credentials via environment variables).  This will be inferred unless directly specified.
        :param scratch_s3_url: An s3:// URL used as a base directory where temporary files/directories can be created.  This is necessary for Amazon Redshift, which supports only S3 for bulk import/export.
        :param default_db_facts: Information about the database connection that should be made.  This is a dictionary with string keys of type `DBFacts <https://db-facts.readthedocs.io/en/latest/db_facts.html#db_facts.DBFacts>`_
