...
def fileConfig(fname: Any, defaults: Optional[Any] = ..., disable_existing_loggers: bool = ...) -> None: ...
...
class DictConfigurator(BaseConfigurator):
    ...
    def common_logger_config(self, logger: Any, config: Any, incremental: bool = ...) -> None: ...
    def configure_logger(self, name: Any, config: Any, incremental: bool = ...) -> None: ...
