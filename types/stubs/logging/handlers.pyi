...
class BaseRotatingHandler(logging.FileHandler):
    ...
    namer: Any = ...
    rotator: Any = ...
    def __init__(self, filename: Any, mode: Any, encoding: Optional[Any] = ..., delay: bool = ...) -> None: ...
...
class RotatingFileHandler(BaseRotatingHandler):
    maxBytes: Any = ...
    backupCount: Any = ...
    def __init__(self, filename: Any, mode: str = ..., maxBytes: int = ..., backupCount: int = ..., encoding: Optional[Any] = ..., delay: bool = ...) -> None: ...
    stream: Any = ...
...
class TimedRotatingFileHandler(BaseRotatingHandler):
    ...
    dayOfWeek: Any = ...
    rolloverAt: Any = ...
    def __init__(self, filename: Any, when: str = ..., interval: int = ..., backupCount: int = ..., encoding: Optional[Any] = ..., delay: bool = ..., utc: bool = ..., atTime: Optional[Any] = ...) -> None: ...
...
class WatchedFileHandler(logging.FileHandler):
    def __init__(self, filename: Any, mode: str = ..., encoding: Optional[Any] = ..., delay: bool = ...) -> None: ...
    stream: Any = ...
...
class SysLogHandler(logging.Handler):
    ...
    unixsocket: bool = ...
    socket: Any = ...
    def __init__(self, address: Any = ..., facility: Any = ..., socktype: Optional[Any] = ...) -> None: ...
...
class SMTPHandler(logging.Handler):
    ...
    secure: Any = ...
    timeout: Any = ...
    def __init__(self, mailhost: Any, fromaddr: Any, toaddrs: Any, subject: Any, credentials: Optional[Any] = ..., secure: Optional[Any] = ..., timeout: float = ...) -> None: ...
...
class NTEventLogHandler(logging.Handler):
    ...
    deftype: Any = ...
    typemap: Any = ...
    def __init__(self, appname: Any, dllname: Optional[Any] = ..., logtype: str = ...) -> None: ...
...
class HTTPHandler(logging.Handler):
    ...
    credentials: Any = ...
    context: Any = ...
    def __init__(self, host: Any, url: Any, method: str = ..., secure: bool = ..., credentials: Optional[Any] = ..., context: Optional[Any] = ...) -> None: ...
...
class MemoryHandler(BufferingHandler):
    ...
    target: Any = ...
    flushOnClose: Any = ...
    def __init__(self, capacity: Any, flushLevel: Any = ..., target: Optional[Any] = ..., flushOnClose: bool = ...) -> None: ...
    def shouldFlush(self, record: Any): ...
...
class QueueListener:
    ...
    def __init__(self, queue: Any, *handlers: Any, respect_handler_level: bool = ...) -> None: ...
