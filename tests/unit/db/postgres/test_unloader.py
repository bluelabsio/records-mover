...
class TestPostgresUnloader(unittest.TestCase):
    def setUp(self):
        ...
        self.loader = PostgresUnloader(self.mock_db)
    ...
    def test_unload(self,
        ...
        self.loader.unload(mock_schema,
                           mock_table,
                           mock_unload_plan,
                           mock_directory)
        ...
        mock_fileobj = mock_directory.loc.file_in_this_directory.return_value.open.return_value.__enter__.return_value
