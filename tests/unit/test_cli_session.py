...
class TestCLISession(unittest.TestCase):
    ...
    def test_db_driver_with_guessed_bucket_url(self,
        ...
        mock_UrlResolver.assert_called_with(boto3_session_getter=context._default_boto3_session,
                                            gcp_credentials_getter=context._default_gcs_creds,
                                            gcs_client_getter=context._default_gcs_client)
